...
import insta from '../assets/images/followers-icon.png';
import book from '../assets/images/books-icon.png';
import expertise from '../assets/images/experience-icon.png';
import { useNavigate } from "react-router-dom";
function CourseDescriptionHero() {
