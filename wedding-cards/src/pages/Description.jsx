...
import weddingRing from "../assets/images/ring1.jpg";
...
const Description = () => {
  ...
  // ✅ Handle outside click and ESC to close modal
  useEffect(() => {
    ...
    <>
      ...
      {showWeddingModal && (
        <div className="fixed inset-0 z-50 flex items-center justify-center bg-black bg-opacity-50">
          <div
            ref={modalRef}
            className="relative bg-[#ffe3b9] rounded-lg shadow-lg max-w-2xl w-full p-4 max-h-[100vh] overflow-hidden"
          >
            <button
