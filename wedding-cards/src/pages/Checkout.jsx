        ...
        <div className="flex-1  p-6 rounded-xl shadow-md">
         <img src={logo} alt="Logo" className="w-40 mx-auto mb-6" />
          ...
          <p className="text-sm text-gray-700 mb-4">
            Order ID: <span className="font-medium">356958190</span><br />
          ...
          <div className="flex items-center gap-4 mb-4">
            ...
            <div className="flex-1">
              <div className="text-sm font-medium text-gray-800">SKU: KSN0054</div>
              <div className="text-sm text-gray-600">SN (SN 54)</div>
            </div>
            <div className="font-semibold text-gray-800">Rs. 153.00</div>
          </div>
